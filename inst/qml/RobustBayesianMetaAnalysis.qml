...
Form
{
	...
	"- Bartoš F, Maier M, Wagenmakers EJ, Doucouliagos H, Stanley TD (2023). “Robust Bayesian meta-analysis: Model-averaging across complementary publication bias adjustment methods.” _Research Synthesis Methods, 14_(1), 99–116. https://doi.org/10.1002/jrsm.1594\n" +
	...
	"- Bartoš F, Maier M, Wagenmakers EJ (2026). “Robust Bayesian multilevel meta-analysis: Adjusting for publication bias in the presence of dependent effect sizes”  _Behavior Research Methods 58_(165) https://doi.org/10.3758/s13428-026-03023-y\n" +
	"- Maier M, Bartoš F, Wagenmakers EJ (2023). “Robust Bayesian meta-analysis: Addressing publication bias with model-averaging.” _Psychological Methods, 28_(1), 107–122. https://doi.org/10.1037/met0000405\n" +
