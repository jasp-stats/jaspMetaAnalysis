context("Other: Forest Plot - standalone")

# This test file was auto-generated from a JASP example file.
# The JASP file is stored in tests/testthat/jaspfiles/other/.

test_that("ForestPlot (analysis 1) results match", {

  # Load from JASP example file
  jaspFile <- testthat::test_path("jaspfiles", "other", "Forest Plot - standalone.jasp")
  ...
  set.seed(1)
  results <- jaspTools::runAnalysis("ForestPlot", encoded$dataset, encoded$options, encodedDataset = TRUE)
...
test_that("ForestPlot (analysis 2) results match", {
...
test_that("ForestPlot (analysis 3) results match", {
...
test_that("ForestPlot (analysis 4) results match", {
...
test_that("ForestPlot (analysis 5) results match", {
...
test_that("ForestPlot (analysis 6) results match", {
